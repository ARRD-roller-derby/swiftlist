...
interface DelItemButtonProps {
  id: number
}
export function DelItemButton({ id }: DelItemButtonProps) {
  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className="text-sm font-medium text-red-800 hover:bg-opacity-30 focus:outline-none"
      >
        Supprimer
      </button>
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Vous êtes sur le point de supprimer la ligne. Cette action
                      est irréversible.
                    </p>
                  </div>
